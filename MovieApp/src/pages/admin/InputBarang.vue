  ...
  <q-page padding>
    ...
    <q-card flat>
      <q-card-section class="row">
        <q-form
          @submit="onSubmit()"
          class="q-col-gutter-md q-lg-6 col-md-6 col-xs-12"
        >
          <q-input
            filled
            v-model="form.judulFilm"
            label="Judul Film"
            :rules="[ val => val && val.length > 0 || 'Tolong Isi Judul']"
          />
          ...
          <q-input
            ...
            type="number"
            label="Harga"
            :rules="[ val => val > 0 || 'Tolong Isi Harga']"
          />
          ...
          <q-input
            ...
            v-model="form.tahun"
            label="Tahun Film"
            :rules="[ val => val && val.length > 0 || 'Tolong Isi Tahun']"
          />
